-- Fix weekly goal to cap at target instead of continuing to increment
-- This prevents showing 5/4, 6/4, etc. on the weekly progress
...
BEGIN
  ...
  -- 4. Create or update weekly goal (CAP AT TARGET - don't increment past goal)
